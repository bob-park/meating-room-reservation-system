...
==== Path Parameters
include::{snippets}/admin-company-controller-test/remove-test/custom-path-param-fields.adoc[]

==== Request Example
include::{snippets}/admin-company-controller-test/remove-test/http-request.adoc[]


==== Response Example
include::{snippets}/admin-company-controller-test/remove-test/http-response.adoc[]
